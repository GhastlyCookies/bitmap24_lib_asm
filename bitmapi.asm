...
readbitmapi PROC USES ebx ecx edx edi, hwnd:HANDLE, pFH : PTR bitmap24_FILEHEAD, pIH : PTR bitmap24_FILEINFOHEAD, ppa : PTR pixel24
...
writebitmapi PROC, hwnd : HANDLE, pFH : PTR bitmap24_FILEHEAD, pIH : PTR bitmap24_FILEINFOHEAD, ppa : PTR pixel24, pixo : DWORD, wsize : DWORD
